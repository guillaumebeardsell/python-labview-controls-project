...
x_lo, x_hi = nice_limits(float(data["Spark timing"].min()), float(data["Spark timing"].max()))
y_lo, y_hi = nice_limits(float(data["CA50_Fired2_mean [deg]"].min()), float(data["CA50_Fired2_mean [deg]"].max()))
